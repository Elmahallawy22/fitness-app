    ...
    <section className="flex justify-center py-10 bg-white/95 dark:bg-main">
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 p-4 lg:p-0">
        ...
        <div className="order-1 lg:order-2 space-y-9 pt-4 ">
          ...
          {/* description */}
          <p className="text-base lg:text-lg w-full overflow-hidden text-main dark:text-zinc-100">{t("description")} </p>
          {/* info sections */}
          ...
          <div className="flex px-0">
            ...
            <img src={arrow} alt="img-button" className="-ms-2 size-8 rounded-full border-2 border-white bg-orange-600" />
          </div>
        </div>
      </div>
    </section>
