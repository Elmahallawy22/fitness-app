...
export default function Healthy() {
  ...
  return (
    <div className="w-full mt-48 bg-gradient-to-b from-main/20 via-main/5 to-main/90">
      {/* healthy LAYER */}
      <h2 className="relative inline-block text-center bottom-12 -z-1 left-1/2 -translate-x-1/2 text-6xl font-bold bg-gradient-to-b from-white to-[#232425] bg-clip-text text-transparent">
        HEALTHY
      </h2>
